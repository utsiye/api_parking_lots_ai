...
from src.misc.dto.users import UpdateUserInput, ProfileOutput
from src.di.auth import authorize

api_router = APIRouter()


@api_router.put('/profile/update', status_code=200)
async def profile_update_route(user: UpdateUserInput, user_id: int = Depends(authorize),
